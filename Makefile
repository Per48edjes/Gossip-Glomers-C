...
CHALLENGES := challenge-1 challenge-2 challenge-3a challenge-3bc
...
CHALLENGE_3bc_SRC := $(SRC_DIR)/challenge-3bc/challenge-3bc.c
...
CHALLENGE_3bc_OBJS := $(patsubst $(SRC_DIR)/challenge-3bc/%.c, $(BUILD_DIR)/%.o, $(CHALLENGE_3bc_SRC))
...
$(BUILD_DIR)/challenge-3bc.out: $(CHALLENGE_3bc_OBJS) $(BUILD_DIR)/util.o $(BUILD_DIR)/collections.o $(BUILD_DIR)/tcp.o $(BUILD_DIR)/stopwatch.o
	$(CC) $(CFLAGS) $(LDFLAGS) $^ -o $@
...
$(BUILD_DIR)/challenge-3bc.o: $(CHALLENGE_3bc_SRC) $(LIB_DIR)/util.h $(LIB_DIR)/collections.h $(LIB_DIR)/tcp.h $(LIB_DIR)/stopwatch.h
	$(CC) $(CFLAGS) -c $< -o $@
